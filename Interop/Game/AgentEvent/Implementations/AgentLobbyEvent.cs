...
using OmenTools.Interop.Game.AgentEvent.Abstractions;
using OmenTools.Interop.Game.Lumina;

namespace OmenTools.Interop.Game.AgentEvent;

public sealed unsafe class AgentLobbyEvent : AgentEventBase
{
