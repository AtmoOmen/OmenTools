...
public struct ExecuteCommandPacket
(
    ExecuteCommandFlag flag,
    int                param1 = 0,
    int                param2 = 0,
    int                param3 = 0,
    int                param4 = 0
...
{
    [FieldOffset(0)]
    public int Opcode = UpstreamOpcode.ExecuteCommandOpcode;

    [FieldOffset(8)]
    public uint Length = 48;

    [FieldOffset(32)]
    public ExecuteCommandFlag Flag = flag;
    ...
    [FieldOffset(44)]
    public int Param3 = param3;

    [FieldOffset(48)]
    public int Param4 = param4;
