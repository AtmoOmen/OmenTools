...
(
    float                                 charaRotation,
    Vector3                               position,
    PositionUpdateInstancePacket.MoveType moveType = PositionUpdateInstancePacket.MoveType.NormalMove0
) : IUpstreamPacket
{
    [FieldOffset(0)]
    public int Opcode = UpstreamOpcode.PositionUpdateInstanceOpcode;

    [FieldOffset(8)]
    public uint Length = 56;

    [FieldOffset(32)]
    public float Rotation = charaRotation;

    [FieldOffset(36)]
    public float RotationNew = charaRotation;
    ...
    [FieldOffset(56)]
    public Vector3 PositionNew = position;
    ...
    public static void Send(float rotation, Vector3 position, MoveType moveType = MoveType.NormalMove0)
    {
        ...
        var name    = moveStr[..^1];
        var allMoveTypes = MoveTypeCache.GetOrAdd
        (
            name,
            key =>
