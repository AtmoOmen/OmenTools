...
public unsafe struct AgentTradeMultiple : IEnumerable<SelectedMateria>
{
    ...
    [FieldOffset(40)]
    public TradeMultiple TradeMultiple;
...
public unsafe struct TradeMultiple
{
    ...
    [FieldOffset(8)]
    public nint UnkInstane;

    [FieldOffset(32)]
    public int MaxCount;

    [FieldOffset(40)]
    public fixed byte SelectedMateriaData[96];

    public Span<SelectedMateria> SelectedMateria
    {
        get
        {
            fixed (void* ptr = SelectedMateriaData) return new Span<SelectedMateria>(ptr, 6);
        }
    }
    ...
    public void AddMateria(InventoryType inventoryType, ushort slot)
    {
        ...
        fixed (void* ptr = &this) ((delegate* unmanaged[Stdcall]<nint, uint, InventoryType, void>)*VirtualTable)((nint)ptr, slot, inventoryType);
    }
}
