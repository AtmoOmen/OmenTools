...
public readonly struct SeStringParameter
{
    ...
    private readonly LSeString str;

    public bool      IsString    { get; }
    public uint      UIntValue   => IsString ? uint.TryParse(str.ToString(), out var value) ? value : 0 : num;
    public LSeString StringValue => IsString ? str : new ReadOnlySeString(num.ToString());

    public SeStringParameter(uint value) => num = value;

    public SeStringParameter(LSeString value)
    {
        str      = value;
        IsString = true;
    }
