...
public sealed class AuxesiaToMareLamentorum : EventTransportBase
{
    ...
    private const uint SOURCE_ZONE  = 1319;
    private const uint TARGET_ZONE  = 959;
    private const uint NPC_EVENT_ID = 721817;

    private static readonly Vector3 NPCPosition = new(365.1f, 204.1f, 392.0f);
