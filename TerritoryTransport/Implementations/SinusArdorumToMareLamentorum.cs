...
public sealed class SinusArdorumToMareLamentorum : EventTransportBase
{
    ...
    private const uint SOURCE_ZONE  = 1237;
    private const uint TARGET_ZONE  = 959;
    private const uint NPC_EVENT_ID = 721818;

    private static readonly Vector3 NPCPosition = new(-55.3f, -0.0f, -69.0f);
