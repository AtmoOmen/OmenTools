...
public sealed class OizysToMareLamentorum : EventTransportBase
{
    ...
    private const uint SOURCE_ZONE  = 1310;
    private const uint TARGET_ZONE  = 959;
    private const uint NPC_EVENT_ID = 721817;

    private static readonly Vector3 NPCPosition = new(-203.7f, 0.5f, 68.6f);
