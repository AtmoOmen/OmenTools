...
public struct ExecuteCommandPacket(ExecuteCommandFlag flag, int param1 = 0, int param2 = 0, int param3 = 0, int param4 = 0) : IUpstreamPacket
{
    [FieldOffset(0)]  public int                Opcode = UpstreamOpcode.ExecuteCommandOpcode;
