...
public struct UseActionLocationPacket(ActionType type, uint actionID, float rotation, Vector3 location) : IUpstreamPacket
{
    [FieldOffset(0)]  public        int     Opcode   = UpstreamOpcode.UseActionLocationOpcode;
