...
{
    private static AtkUnitBase* RetainerList             => GetAddonByName("RetainerList");
    private static AtkUnitBase* RetainerSell             => GetAddonByName("RetainerSell");
    private static AtkUnitBase* RetainerSellList         => GetAddonByName("RetainerSellList");
    private static AtkUnitBase* ItemSearchResult         => GetAddonByName("ItemSearchResult");
    private static AtkUnitBase* Bank                     => GetAddonByName("Bank");
