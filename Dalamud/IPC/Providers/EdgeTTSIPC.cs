...
public static class EdgeTTSIPC
{
    ...
    public static void Speak(string text, int speed, int pitch, int volume) =>
    ...
    public static Task SpeakAsync(string text, int speed, int pitch, int volume, CancellationToken cancellationToken) =>
    ...
    public static void Synthesize(string text, int speed, int pitch, int volume) =>
    ...
    public static Task SynthesizeAsync(string text, int speed, int pitch, int volume, CancellationToken cancellationToken) =>
